...
INSERT INTO admin.major_roadmaps (id, slug, name, total_credits, created_at, updated_at) VALUES
(1, 'computer-science', 'Computer Science', 136, NOW(), NOW());


INSERT INTO admin.course_nodes
(id, roadmap_id, slug, name, coords, credits, description, created_at, updated_at)
VALUES
...
(id, course_node_id, prerequisite_node_id, created_at, updated_at)
VALUES
-- Math chain
...
(4, 6, 1, NOW(), NOW()),   -- Discrete Mathematics requires Intro To Programming (logical thinking)
...
-- Core CS
(8, 10, 6, NOW(), NOW()),  -- Algorithms & Data Structure requires Discrete Mathematics
(9, 10, 8, NOW(), NOW()),  -- and OOP
(10, 11, 8, NOW(), NOW()), -- Web Application Development requires OOP
(11, 12, 9, NOW(), NOW()), -- Internet of Things requires Computer Network
(12, 13, 10, NOW(), NOW()),-- AI requires Algorithms & Data Structure
(13, 13, 5, NOW(), NOW()); -- AI also requires Probability & Statistics



INSERT INTO admin.course_topics_node
(id, course_node_id, slug, title, description, coords, learning_objectives, resources_url, created_at, updated_at)
VALUES
...
(id, source_topic_id, target_topic_id, created_at)
VALUES
