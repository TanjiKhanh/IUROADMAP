...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\TanKhanh\\Lecture\\2025-2026\\Second Semester\\Software Engineering\\IUROADMAP\\iuroadmap.services\\admin-service\\src\\generated\\prisma-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\TanKhanh\\Lecture\\2025-2026\\Second Semester\\Software Engineering\\IUROADMAP\\iuroadmap.services\\admin-service\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "iuroadmap.services/admin-service/src/generated/prisma-client",
    "admin-service/src/generated/prisma-client",
  ]
...
path.join(process.cwd(), "iuroadmap.services/admin-service/src/generated/prisma-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "iuroadmap.services/admin-service/src/generated/prisma-client/schema.prisma")
