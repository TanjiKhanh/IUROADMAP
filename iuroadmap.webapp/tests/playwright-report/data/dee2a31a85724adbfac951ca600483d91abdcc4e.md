...
- Name: e2e\specs\config\user.spec.ts >> Config — User Management E2E >> TC-USR-10: Non-existent user ID error handling >> should show error result when navigating to non-existent user edit
- Location: e2e\specs\config\user.spec.ts:187:9
