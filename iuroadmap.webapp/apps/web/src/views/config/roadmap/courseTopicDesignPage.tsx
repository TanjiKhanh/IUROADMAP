...
// import { UiPageHeader } from '../../../uikit';
// import {
//   adminService,
...
//   const { data: coursesRes } = useCoursesControllerGetCourses();
//   const allCourses = (coursesRes?.data as any)?.data || [];

//   const { data: graphRes, refetch: loadGraphData } = useCoursesControllerGetCourseTopicsGraph(Number(courseNodeId), {
//     query: { enabled: !!courseNodeId && !isNaN(Number(courseNodeId)) }
//   });

//   const { mutateAsync: createTopicNodeApi } = useCoursesControllerCreateTopicNode();
//   const { mutateAsync: updateTopicNodeApi } = useCoursesControllerUpdateTopicNode();
//   const { mutateAsync: deleteTopicNodeApi } = useCoursesControllerDeleteTopicNode();
//   const { mutateAsync: updateTopicCoordsApi } = useCoursesControllerUpdateTopicCoords();
//   const { mutateAsync: createTopicEdgeApi } = useCoursesControllerCreateTopicEdge();
//   const { mutateAsync: deleteTopicEdgeApi } = useCoursesControllerDeleteTopicEdge();

//   useEffect(() => {
//     if (graphRes?.data) {
//       const graph = graphRes.data as unknown as AdminCourseTopicsGraph;
//       const { flowNodes, flowEdges } = toFlow(graph);
//       setNodes(flowNodes);
//       setEdges(flowEdges);
//       setLoading(false);
//     }
//   }, [graphRes?.data, setNodes, setEdges]);
...
//       // allCourses already fetched from useCoursesControllerGetCourses
...
//     await deleteTopicEdgeApi({ courseNodeId: currentCourseNodeId, edgeId });
...
//   setSaving(true);
//   try {
//     await updateTopicNodeApi({
//       courseNodeId: currentCourseNodeId, topicId, data: {
//         slug: form.slug.trim(),
//         title: form.title.trim(),
//         description: form.description.trim() || undefined,
//         learningObjectives: form.learningObjectives.trim() || undefined,
...
//       setSaving(true);
//       try {
//         await deleteTopicNodeApi({ courseNodeId: currentCourseNodeId, topicId });
//         setNotification({
//           type: 'success',
//           title: 'Topic Deleted',
...
//           title={
//             <div>
//               <div>Course Topic Roadmap Designer</div>
//               <div style={{ fontSize: 14, color: '#666', fontWeight: 'normal', marginTop: 4 }}>
//                 {courseLabel}
//               </div>
//             </div>
//           }
